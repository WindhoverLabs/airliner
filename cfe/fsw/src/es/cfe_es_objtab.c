   ...
   */
   {
		   ...
		   .ObjectFlags = CFE_EVS_START_TASK_FLAGS
   },
   {
           .ObjectType = CFE_ES_NULL_ENTRY
   },
   {
		   ...
		   .ObjectFlags = CFE_SB_START_TASK_FLAGS
   },
   {
           .ObjectType = CFE_ES_NULL_ENTRY
   },
   {
		   ...
		   .ObjectFlags = CFE_ES_START_TASK_FLAGS
   },
   {
           .ObjectType = CFE_ES_NULL_ENTRY
   },
   {
		   ...
		   .ObjectFlags = CFE_TIME_START_TASK_FLAGS
   },
   {
           .ObjectType = CFE_ES_NULL_ENTRY
   },
#ifndef EXCLUDE_CFE_TBL
   {
		   ...
		   .ObjectFlags = CFE_TBL_START_TASK_FLAGS
   },
#else
   {
           .ObjectType = CFE_ES_NULL_ENTRY
