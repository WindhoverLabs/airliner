...
.. graphviz::
   ...
   digraph MAC_Context_Diagram {
      ...
      FILTER_TBL [style=filled, fillcolor="#fbe6ff", shape=folder, width=1, height=1, label="Free Space"]
      ...
      FILTER_TBLE_FILE [style=filled, fillcolor="#fbe6ff", shape=folder, width=1, height=1, label="Free Space table"]
