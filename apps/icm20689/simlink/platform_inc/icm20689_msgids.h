...
#ifndef ICM20689_MSGIDS_H
#define ICM20689_MSGIDS_H
...
/**
** \brief ICM20689 application-specific command MID
*/
#define ICM20689_CMD_MID                 (0x18C0)

/**
** \brief Command for the application to send HK data
*/
#define ICM20689_SEND_HK_MID             (0x18C1)

/**
** \brief Wakeup command for the application to perform processing
*/
#define ICM20689_WAKEUP_MID              (0x18D0)

/**
** \brief Application-specific data output
*/
#define ICM20689_OUT_DATA_MID            (0x18D1)

/**
** \brief Application housekeeping telemetry data
*/
#define ICM20689_HK_TLM_MID              (0x08BB)
