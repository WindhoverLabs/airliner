...
#
# File:  ReadMe.txt
# Desc:  Description of the ICM20689 cFS application
#
#######################################################################################
...
1) ICM20689_WAKEUP_MID
   ...
   it sends out its output data (ICM20689_OUT_DATA_MID) before going back to the
   listening mode.
...
2) ICM20689_SEND_HK_MID

   This message is normally sent by the CFS message scheduler.  Upon receiving this
   message, the application sends out its latest housekepping data (ICM20689_HK_TLM_MID)
   ...
   ICM20689_SEND_HK_MID message.  It should contain ONLY essential data that the ground
...
the ICM20689_WAKEUP_MID and ICM20689_SEND_HK_MID commands over other
messages.
