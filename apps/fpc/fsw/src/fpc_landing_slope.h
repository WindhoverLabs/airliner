...
private:
    ...
    float m_Landing_Slope_Angle_Rad{0.0f};		/**< phi in the plot */
    float m_Flare_Relative_Alt{0.0f};		/**< h_flare,rel in the plot */
    float m_Motor_Lim_Relative_Alt{0.0f};
    float m_H1_Virt{0.0f};				/**< H1 in the plot */
    float m_H0{0.0f};				/**< h_flare,rel + H1 in the plot */
    float m_D1{0.0f};				/**< d1 in the plot */
    float m_Flare_Constant{0.0f};
    float m_Flare_Length{0.0f};			/**< d1 + delta d in the plot */
    float m_Horizontal_Slope_Displacement{0.0f};	/**< delta d in the plot */
...
public:
    ...
    float landing_slope_angle_rad() { return m_Landing_Slope_Angle_Rad; }
    float flare_relative_alt() { return m_Flare_Relative_Alt; }
    float motor_lim_relative_alt() { return m_Motor_Lim_Relative_Alt; }
    float flare_length() { return m_Flare_Length; }
    float horizontal_slope_displacement() { return m_Horizontal_Slope_Displacement; }
