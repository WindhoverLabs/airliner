...
**
** $Id: ut_cfe_es_stubs.c 1.3 2015/03/06 14:37:10EST sstrege Exp  $
**
...
** Revision 1.3 2015/03/06 14:37:10EST sstrege 
...
void Ut_CFE_ES_SetFunctionHook(uint32 Index, void *FunPtr)
{
    ...
    else                                                    { printf("Unsupported ES Index In SetFunctionHook Call %lu\n", Index); }
}
