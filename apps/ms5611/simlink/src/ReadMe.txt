...
#
# File:  ReadMe.txt
# Desc:  Description of the MS5611 cFS application
#
#######################################################################################
...
2) MS5611_SEND_HK_MID

   This message is normally sent by the CFS message scheduler.  Upon receiving this
   message, the application sends out its latest housekepping data (MS5611_HK_TLM_MID)
   ...
   MS5611_SEND_HK_MID message.  It should contain ONLY essential data that the ground
...
the MS5611_WAKEUP_MID and MS5611_SEND_HK_MID commands over other
messages.
