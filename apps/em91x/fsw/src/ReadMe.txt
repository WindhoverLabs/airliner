...
#
# File:  ReadMe.txt
# Desc:  Description of the EM91X cFS application
#
#######################################################################################
...
1) EM91X_WAKEUP_MID
   ...
   it sends out its output data (EM91X_OUT_DATA_MID) before going back to the
   listening mode.
...
2) EM91X_SEND_HK_MID
   ...
   message, the application sends out its latest housekepping data (EM91X_HK_TLM_MID)
   ...
   EM91X_SEND_HK_MID message.  It should contain ONLY essential data that the ground
...
the EM91X_WAKEUP_MID and EM91X_SEND_HK_MID commands over other
messages.
