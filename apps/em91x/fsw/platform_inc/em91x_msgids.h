...
#ifndef EM91X_MSGIDS_H
#define EM91X_MSGIDS_H
...
/**
** \brief EM91X application-specific command MID
*/
#define EM91X_CMD_MID                 (0x18C0)

/**
** \brief Command for the application to send HK data
*/
#define EM91X_SEND_HK_MID             (0x18C1)

/**
** \brief Wakeup command for the application to perform processing
*/
#define EM91X_WAKEUP_MID              (0x18D0)

/**
** \brief Application-specific data output
*/
#define EM91X_OUT_DATA_MID            (0x18D1)

/**
** \brief Application housekeeping telemetry data
*/
#define EM91X_HK_TLM_MID              (0x08BB)
