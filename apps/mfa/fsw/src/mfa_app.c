...
MFA_ConfigTbl_t* MFA_ConfigTblPtr;
...
void MFA_AppMain()
{
    ...
    */
    status = CFE_TBL_GetAddress((void**)&MFA_ConfigTblPtr,
                                MFA_ConfigTblHdl);
    ...
    {
        (void) CFE_EVS_SendEvent(MFA_HELLO_WORLD_EID, CFE_EVS_INFORMATION, "%s", MFA_ConfigTblPtr->Message);
        OS_TaskDelay(1000);
    }
