...
uint32 PX4BR_Actuator_Direct_Enc(const PX4_ActuatorDirectMsg_t *inObject, char *inOutBuffer, uint32 inSize);
...
uint32 PX4BR_Debug_key_value_Dec(const char *inBuffer, uint32 inSize, PX4_DebugKeyValueMsg_t *inOutObject);
...
uint32 PX4BR_FilteredBottom_flow_Dec(const char *inBuffer, uint32 inSize, PX4_FilteredBottomFlowMsg_t *inOutObject);
uint32 PX4BR_FollowTarget_Dec(const char *inBuffer, uint32 inSize, PX4_FollowTargetMsg_t *inOutObject);
uint32 PX4BR_Geofence_result_Dec(const char *inBuffer, uint32 inSize, PX4_GeofenceResultMsg_t *inOutObject);
...
uint32 PX4BR_Transponder_report_Dec(const char *inBuffer, uint32 inSize, PX4_TransponderReportMsg_t *inOutObject);
