...
#
# File:  ReadMe.txt
# Desc:  Description of the CVT cFS application
#
#######################################################################################
...
2) CVT_SEND_HK_MID
   ...
   message, the application sends out its latest housekepping data (CVT_HK_TLM_MID)
   ...
   CVT_SEND_HK_MID message.  It should contain ONLY essential data that the ground
...
the CVT_WAKEUP_MID and CVT_SEND_HK_MID commands over other
messages.
