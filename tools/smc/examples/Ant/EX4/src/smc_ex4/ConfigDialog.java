...
//
// Revision 1.0  2004/05/31 13:09:46  charlesr
// Initial revision
//
...
// Member methods
    ...
    public ConfigDialog(TrafficCanvas canvas)
    {
        ...
        if (_isInitialized == false)
        {
            ...
            _title = new String("Demo Configuration");
    ...
    private Component createComponents()
    {
        ...
        _nsSlider = new JSlider(JSlider.HORIZONTAL,
                                5,
                                20,
                                5);
        ...
        titledBorder.setTitleJustification(TitledBorder.CENTER);
        titledBorder.setTitlePosition(TitledBorder.ABOVE_TOP);
        _ewSlider = new JSlider(JSlider.HORIZONTAL,
                                5,
                                20,
                                5);
        ...
        titledBorder.setTitleJustification(TitledBorder.CENTER);
        titledBorder.setTitlePosition(TitledBorder.ABOVE_TOP);
        _yellowSlider = new JSlider(JSlider.HORIZONTAL,
                                    2,
                                    8,
                                    2);
        ...
        titledBorder.setTitleJustification(TitledBorder.CENTER);
        titledBorder.setTitlePosition(TitledBorder.ABOVE_TOP);
        _vehicleSlider = new JSlider(JSlider.HORIZONTAL,
                                     5,
                                     15,
                                     5);
        ...
        titledBorder.setTitleJustification(TitledBorder.CENTER);
        titledBorder.setTitlePosition(TitledBorder.ABOVE_TOP);
        _speedSlider = new JSlider(JSlider.HORIZONTAL,
                                   1,
                                   5,
                                   1);
    ...
    private void updateCanvas()
    {
        ...
        // accordingly.
        _canvas.setLightDuration(TrafficCanvas.NS_LIGHT,
                                 _nsSlider.getValue());
        _canvas.setLightDuration(TrafficCanvas.EW_LIGHT,
                                 _ewSlider.getValue());
