...
/*
** {{cookiecutter.app_name|lower}} Platform Configuration Parameter Definitions
*/
...
**       parts are defined in "{{cookiecutter.app_name|lower}}_version.h".
**
**  \par Limits:
...
#define {{cookiecutter.app_name}}_CUSTOM_DEV_PATH       "/tmp/ttyS0"
