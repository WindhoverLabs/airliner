...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "fac_config.tbl", (sizeof(FAC_ConfigTblEntry_t) * FAC_CONFIG_TABLE_MAX_ENTRIES)
};
...
*/
FAC_ConfigTblEntry_t FAC_ConfigTbl[FAC_CONFIG_TABLE_MAX_ENTRIES] =
{
    /* Entry 1 */
    {
        .iParam = 123
        ...
        **
        ** Examples: (See example of type declarations in fac_tbldefs.h)
        **    .cParam   = 7,
