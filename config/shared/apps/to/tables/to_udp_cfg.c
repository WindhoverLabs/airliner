...
//        {PX4_SATELLITE_INFO_MID,       1, TO_PQUEUE_LOW_IDX},
        {PX4_SENSOR_ACCEL_MID,         1, TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_BARO_MID,          1, TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_COMBINED_MID,      1, TO_PQUEUE_HIGH_IDX},
//        {PX4_SENSOR_CORRECTION_MID,    1, TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_GYRO_MID,          1, TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_MAG_MID,           1, TO_PQUEUE_HIGH_IDX},
...
//        {PX4_VEHICLE_FORCE_SETPOINT_MID, 1, TO_PQUEUE_LOW_IDX},
        {PX4_VEHICLE_GLOBAL_POSITION_MID, 1, TO_PQUEUE_HIGH_IDX},
//        {PX4_VEHICLE_GLOBAL_VELOCITY_SETPOINT_MID, 1, TO_PQUEUE_LOW_IDX},
        {PX4_VEHICLE_GPS_POSITION_MID, 1,     TO_PQUEUE_HIGH_IDX},
