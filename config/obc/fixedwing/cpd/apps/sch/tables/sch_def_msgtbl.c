...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
   ...
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #96 */
   { { SCH_FIX_HEADER(FAC_SEND_HK_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #97 */
   { { SCH_FIX_HEADER(FAC_RUN_CONTROLLER_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #98 */
   ...
   /* Command ID #101 */
   { { SCH_FIX_HEADER(SBND_WAKEUP_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #102 */
   ...
   /* Command ID #106 */
   { { SCH_FIX_HEADER(FPC_SEND_HK_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #107 */
   { { SCH_FIX_HEADER(FPC_WAKEUP_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #108 */
