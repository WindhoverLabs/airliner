...
PQ_ChannelTbl_t PQ_ConfigTbl =
{
    ...
    1,
    {
        ...
        {RGBLED_HK_TLM_MID,            1, PQ_PQUEUE_LOW_IDX},
        ...
        {AK8963_HK_TLM_MID,            1, PQ_PQUEUE_LOW_IDX},
        {AK8963_DIAG_TLM_MID,          1, PQ_PQUEUE_LOW_IDX},
        {MS5611_HK_TLM_MID,            1, PQ_PQUEUE_LOW_IDX},
        {MS5611_DIAG_TLM_MID,          1, PQ_PQUEUE_LOW_IDX},
        {MPU6050_HK_TLM_MID,           1, PQ_PQUEUE_LOW_IDX},
        {MPU6050_DIAG_TLM_MID,         1, PQ_PQUEUE_LOW_IDX},
        {EA_HK_TLM_MID,                1, PQ_PQUEUE_LOW_IDX},
        {VC_HK_TLM_MID,                1, PQ_PQUEUE_LOW_IDX},
        {GPS_HK_TLM_MID,               1, PQ_PQUEUE_LOW_IDX},
        {MAVLINK_HK_TLM_MID,           1, PQ_PQUEUE_LOW_IDX},
        ...
        {FLOW_HK_TLM_MID,              1, PQ_PQUEUE_LOW_IDX},
        {FLOW_DIAG_TLM_MID,            1, PQ_PQUEUE_LOW_IDX},
        {MPC_DIAG_TLM_MID,             1, PQ_PQUEUE_LOW_IDX},
        {LD_DIAG_TLM_MID,              1, PQ_PQUEUE_LOW_IDX},
        {PRM_HK_TLM_MID,               1, PQ_PQUEUE_LOW_IDX},
