...
TO_ChannelTbl_t TO_ConfigTbl =
{
    ...
    {
        /* Message Flows */
        {FROM_CPD(AMC_HK_TLM_MID),               1, TO_PQUEUE_CPD_HK_IDX},
        ...
        {FROM_CPD(CFE_ES_MEMSTATS_TLM_MID),      1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CFE_ES_SHELL_TLM_MID),        32, TO_PQUEUE_CPD_SHELL_IDX},
        {FROM_CPD(CFE_EVS_EVENT_MSG_MID),       32, TO_PQUEUE_CPD_EVENTS_IDX},
        {FROM_CPD(CFE_EVS_HK_TLM_MID),           1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CFE_SB_HK_TLM_MID),            1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CFE_SB_STATS_TLM_MID),         1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CFE_TBL_HK_TLM_MID),           1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CFE_TBL_REG_TLM_MID),          1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CFE_TIME_HK_TLM_MID),          1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CFE_TIME_DIAG_TLM_MID),        1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CI_HK_TLM_MID),                1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(CS_HK_TLM_MID),                1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(DS_DIAG_TLM_MID),              1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(DS_HK_TLM_MID),                1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(FM_DIR_LIST_TLM_MID),          1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(FM_FILE_INFO_TLM_MID),         1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(FM_FREE_SPACE_TLM_MID),        1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(FM_HK_TLM_MID),                1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(FM_OPEN_FILES_TLM_MID),        1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(HK_HK_TLM_MID),                1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(HS_HK_TLM_MID),                1, TO_PQUEUE_CPD_HK_IDX},
        ...
        {FROM_CPD(MPC_DIAG_TLM_MID),             1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(MPC_HK_TLM_MID),               1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(NAV_HK_TLM_MID),               1, TO_PQUEUE_CPD_HK_IDX},
        ...
        {FROM_CPD(ULR_HK_TLM_MID),               1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(VM_CONFIG_TLM_MID),            1, TO_PQUEUE_CPD_HK_IDX},
        ...
        {FROM_CPD(ICM20689_HK_TLM_MID),          1, TO_PQUEUE_CPD_HK_IDX},
        {FROM_CPD(ICM20689_DIAG_TLM_MID),        1, TO_PQUEUE_CPD_HK_IDX},
        ...
        {CFE_ES_MEMSTATS_TLM_MID,                1, TO_PQUEUE_PPD_HK_IDX},
        {CFE_ES_SHELL_TLM_MID,                  32, TO_PQUEUE_PPD_SHELL_IDX},
        {CFE_EVS_EVENT_MSG_MID,                 32, TO_PQUEUE_PPD_EVENTS_IDX},
        {CFE_EVS_HK_TLM_MID,                     1, TO_PQUEUE_PPD_HK_IDX},
        {CFE_SB_HK_TLM_MID,                      1, TO_PQUEUE_PPD_HK_IDX},
        {CFE_SB_STATS_TLM_MID,                   1, TO_PQUEUE_PPD_HK_IDX},
        {CFE_TBL_HK_TLM_MID,                     1, TO_PQUEUE_PPD_HK_IDX},
        {CFE_TBL_REG_TLM_MID,                    1, TO_PQUEUE_PPD_HK_IDX},
        {CFE_TIME_HK_TLM_MID,                    1, TO_PQUEUE_PPD_HK_IDX},
        {CFE_TIME_DIAG_TLM_MID,                  1, TO_PQUEUE_PPD_HK_IDX},
        {CI_HK_TLM_MID,                          1, TO_PQUEUE_PPD_HK_IDX},
        {CS_HK_TLM_MID,                          1, TO_PQUEUE_PPD_HK_IDX},
        {DS_DIAG_TLM_MID,                        1, TO_PQUEUE_PPD_HK_IDX},
        {DS_HK_TLM_MID,                          1, TO_PQUEUE_PPD_HK_IDX},
        {EA_HK_TLM_MID,                          1, TO_PQUEUE_PPD_HK_IDX},
        {FM_DIR_LIST_TLM_MID,                    1, TO_PQUEUE_PPD_HK_IDX},
        {FM_FILE_INFO_TLM_MID,                   1, TO_PQUEUE_PPD_HK_IDX},
        ...
        {MD_HK_TLM_MID,                          1, TO_PQUEUE_PPD_HK_IDX},
        {MM_HK_TLM_MID,                          1, TO_PQUEUE_PPD_HK_IDX},
        {SBN_MODULE_HK_TLM_MID,                  1, TO_PQUEUE_PPD_HK_IDX},
...
//        {PX4_ACTUATOR_CONTROLS_3_MID,  1, TO_PQUEUE_CPD_PX4LOW_IDX},
...
//        {PX4_LOG_MESSAGE_MID,          1, TO_PQUEUE_CPD_PX4LOW_IDX},
        {PX4_MANUAL_CONTROL_SETPOINT_MID, 1, TO_PQUEUE_CPD_PX4LOW_IDX},
...
//        {PX4_PARAMETER_UPDATE_MID,     1, TO_PQUEUE_CPD_PX4LOW_IDX},
        {PX4_POSITION_SETPOINT_TRIPLET_MID, 1, TO_PQUEUE_CPD_PX4LOW_IDX},
...
//        {PX4_SENSOR_ACCEL_MID,         1, TO_PQUEUE_CPD_PX4LOW_IDX},
        {FROM_CPD(PX4_SENSOR_ACCEL_MID), 1, TO_PQUEUE_CPD_PX4LOW_IDX},
//        {PX4_SENSOR_BARO_MID,          1, TO_PQUEUE_CPD_PX4LOW_IDX},
        {FROM_CPD(PX4_SENSOR_BARO_MID), 1, TO_PQUEUE_CPD_PX4LOW_IDX},
        {FROM_CPD(PX4_SENSOR_COMBINED_MID),      1, TO_PQUEUE_CPD_PX4LOW_IDX},
//        {PX4_SENSOR_CORRECTION_MID,    1, TO_PQUEUE_CPD_PX4LOW_IDX},
//        {PX4_SENSOR_GYRO_MID,          1, TO_PQUEUE_CPD_PX4LOW_IDX},
        {FROM_CPD(PX4_SENSOR_GYRO_MID), 1, TO_PQUEUE_CPD_PX4LOW_IDX},
//        {PX4_SENSOR_MAG_MID,           1, TO_PQUEUE_CPD_PX4LOW_IDX},
        {FROM_CPD(PX4_SENSOR_MAG_MID), 1, TO_PQUEUE_CPD_PX4LOW_IDX},
