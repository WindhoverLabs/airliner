...
TO_ChannelTbl_t TO_ConfigTbl =
{
    ...
    1,
    {
        ...
        {MAC_HK_TLM_MID,                       1, TO_PQUEUE_CPD_HK_IDX        },
        {MD_HK_TLM_MID,                        1, TO_PQUEUE_CPD_HK_IDX        },
        {MM_HK_TLM_MID,                        1, TO_PQUEUE_CPD_HK_IDX        },
        {MPC_DIAG_TLM_MID,                     1, TO_PQUEUE_CPD_HIGH_IDX      },
        {MPC_HK_TLM_MID,                       1, TO_PQUEUE_CPD_HK_IDX        },
        ...
        {RGBLED_HK_TLM_MID,                    1, TO_PQUEUE_CPD_HK_IDX        },
        ...
        {SED_HK_TLM_MID,                       1, TO_PQUEUE_CPD_HK_IDX        },
...
//		{PX4_ACTUATOR_CONTROLS_0_MID,          1, TO_PQUEUE_CPD_PX4LOW_IDX    },
...
//        {PX4_SENSOR_COMBINED_MID,              1, TO_PQUEUE_CPD_HIGH_IDX      },
