#ifndef ULR_PLATFORM_CFG_H
#define ULR_PLATFORM_CFG_H
...
/** \brief Mission specific version number for ULR application
**  
**  \par Description:
...
*/
#define ULR_SCH_PIPE_NAME              ("ULR_SCH_PIPE")
...
*/
#define ULR_SCH_PIPE_PEND_TIME         (2000)
...
**       Note, this name must fit in OS_MAX_API_NAME.
*/
#define ULR_CMD_PIPE_NAME              ("ULR_CMD_PIPE")
