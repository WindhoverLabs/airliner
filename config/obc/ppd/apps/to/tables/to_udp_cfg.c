...
TO_ChannelTbl_t TO_ConfigTbl =
{
    ...
    1,
    {
        ...
        {ZUSUP_HK_TLM_MID,             1, TO_PQUEUE_HIGH_IDX},
        {ZUSUP_DIAG_TLM_MID,           1, TO_PQUEUE_HIGH_IDX},
        ...
        {CFE_TBL_HK_TLM_MID_CPD,      1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_TIME_HK_TLM_MID_CPD,     1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_TIME_DIAG_TLM_MID_CPD,   1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_EVS_EVENT_MSG_MID_CPD,  32, TO_PQUEUE_EVENTS_IDX},
        {CFE_SB_STATS_TLM_MID_CPD,    1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_ES_APP_TLM_MID_CPD,      1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_TBL_REG_TLM_MID_CPD,     1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_ES_SHELL_TLM_MID_CPD,   32, TO_PQUEUE_SHELL_IDX},
