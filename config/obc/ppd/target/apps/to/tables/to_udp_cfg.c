...
#define CFE_ES_HK_TLM_MID_CPU2       (CFE_TLM_MID_BASE_CPU2 + CFE_ES_HK_TLM_MSG)
#define CFE_EVS_HK_TLM_MID_CPU2      (CFE_TLM_MID_BASE_CPU2 + CFE_EVS_HK_TLM_MSG)
#define CFE_SB_HK_TLM_MID_CPU2       (CFE_TLM_MID_BASE_CPU2 + CFE_SB_HK_TLM_MSG)
#define CFE_TBL_HK_TLM_MID_CPU2      (CFE_TLM_MID_BASE_CPU2 + CFE_TBL_HK_TLM_MSG)
#define CFE_TIME_HK_TLM_MID_CPU2     (CFE_TLM_MID_BASE_CPU2 + CFE_TIME_HK_TLM_MSG)
#define CFE_TIME_DIAG_TLM_MID_CPU2   (CFE_TLM_MID_BASE_CPU2 + CFE_TIME_DIAG_TLM_MSG)
#define CFE_EVS_EVENT_MSG_MID_CPU2   (CFE_TLM_MID_BASE_CPU2 + CFE_EVS_EVENT_MSG_MSG)
#define CFE_SB_STATS_TLM_MID_CPU2    (CFE_TLM_MID_BASE_CPU2 + CFE_SB_STATS_TLM_MSG)
...
#define CFE_ES_SHELL_TLM_MID_CPU2    (CFE_TLM_MID_BASE_CPU2 + CFE_ES_SHELL_TLM_MSG)
#define CFE_ES_MEMSTATS_TLM_MID_CPU2 (CFE_TLM_MID_BASE_CPU2 + CFE_ES_MEMSTATS_TLM_MSG)
...
TO_ChannelTbl_t TO_ConfigTbl =
{
    ...
    1,
    {
        ...
        /* CPU2 CFE Mids */
        {CFE_ES_HK_TLM_MID_CPU2,       1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_EVS_HK_TLM_MID_CPU2,      1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_SB_HK_TLM_MID_CPU2,       1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_TBL_HK_TLM_MID_CPU2,      1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_TIME_HK_TLM_MID_CPU2,     1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_TIME_DIAG_TLM_MID_CPU2,   1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_EVS_EVENT_MSG_MID_CPU2,  32, TO_PQUEUE_MEDIUM_IDX},
        {CFE_SB_STATS_TLM_MID_CPU2,    1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_ES_APP_TLM_MID_CPU2,      1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_TBL_REG_TLM_MID_CPU2,     1, TO_PQUEUE_MEDIUM_IDX},
        {CFE_ES_SHELL_TLM_MID_CPU2,   32, TO_PQUEUE_MEDIUM_IDX},
        {CFE_ES_MEMSTATS_TLM_MID_CPU2, 1, TO_PQUEUE_MEDIUM_IDX},
