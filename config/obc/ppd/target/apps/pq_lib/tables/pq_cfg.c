...
PQ_ChannelTbl_t PQ_ConfigTbl =
{
	...
	{SBN_UNSUB_MID,                1, PQ_PQUEUE_HIGH_IDX},
        {AMC_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {MAC_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {MPC_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {ULR_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {RGBLED_HK_TLM_MID,            1, PQ_PQUEUE_HIGH_IDX},
        {GPS_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {SENS_HK_TLM_MID,              1, PQ_PQUEUE_HIGH_IDX},
        {LD_HK_TLM_MID,                1, PQ_PQUEUE_HIGH_IDX},
        {NAV_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {RCIN_HK_TLM_MID,              1, PQ_PQUEUE_HIGH_IDX},
        {VM_HK_TLM_MID,                1, PQ_PQUEUE_HIGH_IDX},
        {BAT_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {PE_HK_TLM_MID,                1, PQ_PQUEUE_HIGH_IDX},
        {AK8963_HK_TLM_MID,            1, PQ_PQUEUE_HIGH_IDX},
        {AK8963_DIAG_TLM_MID,          1, PQ_PQUEUE_HIGH_IDX},
        {MS5611_HK_TLM_MID,            1, PQ_PQUEUE_HIGH_IDX},
        {MS5611_DIAG_TLM_MID,          1, PQ_PQUEUE_HIGH_IDX},
        {MPU6050_HK_TLM_MID,           1, PQ_PQUEUE_HIGH_IDX},
        {MPU6050_DIAG_TLM_MID,         1, PQ_PQUEUE_HIGH_IDX},
        {TO_HK_TLM_MID,                1, PQ_PQUEUE_HIGH_IDX},
        {TO_DATA_TYPE_MID,             1, PQ_PQUEUE_HIGH_IDX},
        {EA_HK_TLM_MID,                1, PQ_PQUEUE_HIGH_IDX},
        {VC_HK_TLM_MID,                1, PQ_PQUEUE_HIGH_IDX},
        {TO_DIAG_TLM_MID,              1, PQ_PQUEUE_HIGH_IDX},
        {TO_DIAG_MSG_FLOW_MID,         1, PQ_PQUEUE_HIGH_IDX},
        {GPS_HK_TLM_MID,               1, PQ_PQUEUE_HIGH_IDX},
        {MAVLINK_HK_TLM_MID,           1, PQ_PQUEUE_HIGH_IDX},
        {CFE_ES_HK_TLM_MID,            1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_EVS_HK_TLM_MID,           1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_SB_HK_TLM_MID,            1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_TBL_HK_TLM_MID,           1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_TIME_HK_TLM_MID,          1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_TIME_DIAG_TLM_MID,        1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_EVS_EVENT_MSG_MID,       32, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_SB_STATS_TLM_MID,         1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_ES_APP_TLM_MID,           1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_TBL_REG_TLM_MID,          1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_SB_ONESUB_TLM_MID,        1, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_ES_SHELL_TLM_MID,        32, PQ_PQUEUE_MEDIUM_IDX},
        {CFE_ES_MEMSTATS_TLM_MID,      1, PQ_PQUEUE_MEDIUM_IDX},
        {CF_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {CF_TRANS_TLM_MID,             1, PQ_PQUEUE_MEDIUM_IDX},
        {CF_CONFIG_TLM_MID,            1, PQ_PQUEUE_MEDIUM_IDX},
        {CF_SPACE_TO_GND_PDU_MID,     32, PQ_PQUEUE_MEDIUM_IDX},
        {CS_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {DS_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {DS_DIAG_TLM_MID,              1, PQ_PQUEUE_MEDIUM_IDX},
        {FM_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {FM_FILE_INFO_TLM_MID,         1, PQ_PQUEUE_MEDIUM_IDX},
        {FM_DIR_LIST_TLM_MID,          1, PQ_PQUEUE_MEDIUM_IDX},
        {FM_OPEN_FILES_TLM_MID,        1, PQ_PQUEUE_MEDIUM_IDX},
        {FM_FREE_SPACE_TLM_MID,        1, PQ_PQUEUE_MEDIUM_IDX},
        {HK_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {HS_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {LC_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {MD_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {MM_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {SCH_HK_TLM_MID,               1, PQ_PQUEUE_MEDIUM_IDX},
        {SCH_DIAG_TLM_MID,             1, PQ_PQUEUE_MEDIUM_IDX},
        {CI_HK_TLM_MID,                1, PQ_PQUEUE_MEDIUM_IDX},
        {QAE_HK_TLM_MID,               1, PQ_PQUEUE_MEDIUM_IDX},
        {FLOW_HK_TLM_MID,              1, PQ_PQUEUE_MEDIUM_IDX},
        {FLOW_DIAG_TLM_MID,            1, PQ_PQUEUE_MEDIUM_IDX},
        {MPC_DIAG_TLM_MID,             1, PQ_PQUEUE_MEDIUM_IDX},
        {LD_DIAG_TLM_MID,              1, PQ_PQUEUE_MEDIUM_IDX},
        {PRM_HK_TLM_MID,               1, PQ_PQUEUE_MEDIUM_IDX},
        {VM_CONFIG_TLM_MID,            1, PQ_PQUEUE_MEDIUM_IDX},
