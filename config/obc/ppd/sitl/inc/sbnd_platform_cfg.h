...
#define SBND_CONFIG_MAX_MIDS            (32)
...
*/
#define SBND_CONFIG_TABLE_FILENAME      ("/cf/apps/sbnd_config.tbl")
...
#define SBND_DEFAULT_READ_SHMEM_KEY_FILE      ".sbnd_cpd_shmem"
#define SBND_WRITE_SHMEM_KEY_FILE_ENV_VAR_NAME "SBND_WRITE_SHMEM_KEY_FILE"
#define SBND_DEFAULT_WRITE_SHMEM_KEY_FILE      ".sbnd_ppd_shmem"
