...
#define FAC_SEND_HK_MIDX              96
#define FAC_RUN_CONTROLLER_MIDX       97

#define SBN_WAKEUP_MIDX               98
#define SBN_SEND_HK_MIDX              99
#define SBND_SEND_HK_MIDX             100
#define SBND_WAKEUP_MIDX              101
...
#define SCH_250HZ_GROUP_1         \
     ...
     { SCH_ENABLED,  SCH_ACTIVITY_SEND_MSG,  1,  0,  FAC_RUN_CONTROLLER_MIDX,  SCH_GROUP_NONE }, \
...
SCH_ScheduleEntry_t SCH_DefaultScheduleTable[SCH_TABLE_ENTRIES] =
{
	    ...
	    SCH_50HZ_GROUP_1,
	    SCH_25HZ_GROUP_1,
		{ SCH_ENABLED,	SCH_ACTIVITY_SEND_MSG,	1,	0,	FAC_SEND_HK_MIDX,         SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
	    ...
	    SCH_50HZ_GROUP_4,
	    SCH_25HZ_GROUP_9,
                { SCH_ENABLED,    SCH_ACTIVITY_SEND_MSG,    1,    0,     HES_WAKEUP_MIDX,          SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
		{ SCH_UNUSED,	0,	                    0,	0,	0,	                      SCH_GROUP_NONE },
