...
#define HES_PX4_VEHICLE_GLOBAL_POSITION_MID     (TO_CPD(PX4_VEHICLE_GLOBAL_POSITION_MID))
#define HES_PX4_VEHICLE_ATTITUDE_MID            (TO_CPD(PX4_VEHICLE_ATTITUDE_MID))
#define HES_PX4_AIRSPEED_MID                    (TO_CPD(PX4_AIRSPEED_MID))
#define HES_PX4_BATTERY_STATUS_MID              (TO_CPD(PX4_BATTERY_STATUS_MID))
#define HES_PX4_VEHICLE_LAND_DETECTED_MID       (TO_CPD(PX4_VEHICLE_LAND_DETECTED_MID))
#define HES_PX4_VEHICLE_STATUS_MID              (TO_CPD(PX4_VEHICLE_STATUS_MID))
#define HES_PX4_POSITION_SETPOINT_TRIPLET_MID   (TO_CPD(PX4_POSITION_SETPOINT_TRIPLET_MID))
