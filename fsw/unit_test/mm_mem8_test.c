 /*************************************************************************
 ** File:
 **   $Id: mm_mem8_test.c 1.4.1.1 2016/11/17 16:35:29EST sstrege Exp  $
 **
 ** Purpose: 
 **   This file contains unit test cases for the functions contained in the file mm_mem8.c
 **
 ** References:
 ...
 **   
 **   Revision 1.5 2016/11/17 12:51:14EST mdeschu 
...
void MM_LoadMem8FromFile_Test_Nominal (void)
{
    ...
    Result = MM_LoadMem8FromFile(FileHandle, "filename", &FileHeader, DestAddress);

    /* Verify results */
    UtAssert_True (Result == TRUE, "Result == TRUE");
    UtAssert_True (MM_AppData.LastAction == MM_LOAD_FROM_FILE, "MM_AppData.LastAction == MM_LOAD_FROM_FILE");
    UtAssert_True (MM_AppData.MemType == MM_MEM8, "MM_AppData.MemType == MM_MEM8");
...
void MM_DumpMem8ToFile_Test_Nominal (void)
{
    ...
    /* Execute the function being tested */
    Result = MM_DumpMem8ToFile(FileHandle, "filename", &FileHeader);
...
void MM_DumpMem8ToFile_Test_ReadError (void)
{
    ...
    sprintf (ErrorMessage, "PSP read memory error: RC=0xFFFFFFFF, Src=0x%08X, Tgt=0x%08X, Type=MEM8", (unsigned int)FileHeader.SymAddress.Offset, (unsigned int)&MM_AppData.DumpBuffer[0]);
    UtAssert_True
...
void MM_FillMem8_Test_Nominal (void)
{
    ...
    /* Execute the function being tested */
    MM_FillMem8(DestAddress, &CmdPacket);
...
void MM_Mem8_Test_AddTestCases(void)
{
    ...
    UtTest_Add(MM_LoadMem8FromFile_Test_ReadError, MM_Test_Setup, MM_Test_TearDown, "MM_LoadMem8FromFile_Test_ReadError");
    UtTest_Add(MM_LoadMem8FromFile_Test_WriteError, MM_Test_Setup, MM_Test_TearDown, "MM_LoadMem8FromFile_Test_WriteError");
