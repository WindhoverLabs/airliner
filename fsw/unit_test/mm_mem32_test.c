 /*************************************************************************
 ** File:
 **   $Id: mm_mem32_test.c 1.4.1.1 2016/11/17 16:35:29EST sstrege Exp  $
 **
 ** Purpose: 
 **   This file contains unit test cases for the functions contained in the file mm_mem32.c
 **
 ** References:
...
void MM_LoadMem32FromFile_Test_Nominal (void)
{
    ...
    Result = MM_LoadMem32FromFile(FileHandle, "filename", &FileHeader, DestAddress);

    /* Verify results */
    UtAssert_True (Result == TRUE, "Result == TRUE");
    UtAssert_True (MM_AppData.LastAction == MM_LOAD_FROM_FILE, "MM_AppData.LastAction == MM_LOAD_FROM_FILE");
    UtAssert_True (MM_AppData.MemType == MM_MEM32, "MM_AppData.MemType == MM_MEM32");
...
void MM_LoadMem32FromFile_Test_ReadError (void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(MM_OS_READ_ERR_EID, CFE_EVS_ERROR, "OS_read error received: RC = 0xFFFFFFFF Expected = 4 File = 'filename'"),
        "OS_read error received: RC = 0xFFFFFFFF Expected = 4 File = 'filename'");
...
void MM_DumpMem32ToFile_Test_Nominal (void)
{
    ...
    /* Execute the function being tested */
    Result = MM_DumpMem32ToFile(FileHandle, "filename", &FileHeader);
...
void MM_DumpMem32ToFile_Test_ReadError (void)
{
    ...
    sprintf (ErrorMessage, "PSP read memory error: RC=0xFFFFFFFF, Src=0x%08X, Tgt=0x%08X, Type=MEM32", (unsigned int)FileHeader.SymAddress.Offset, (unsigned int)&MM_AppData.DumpBuffer[0]);
    UtAssert_True
...
void MM_FillMem32_Test_Nominal (void)
{
    ...
    /* Execute the function being tested */
    MM_FillMem32(DestAddress, &CmdPacket);
...
void MM_Mem32_Test_AddTestCases(void)
{
    UtTest_Add(MM_LoadMem32FromFile_Test_Nominal, MM_Test_Setup, MM_Test_TearDown, "MM_LoadMem32FromFile_Test_Nominal");
    UtTest_Add(MM_LoadMem32FromFile_Test_CPUHogging, MM_Test_Setup, MM_Test_TearDown, "MM_LoadMem32FromFile_Test_CPUHogging");
    UtTest_Add(MM_LoadMem32FromFile_Test_ReadError, MM_Test_Setup, MM_Test_TearDown, "MM_LoadMem32FromFile_Test_ReadError");
    UtTest_Add(MM_LoadMem32FromFile_Test_WriteError, MM_Test_Setup, MM_Test_TearDown, "MM_LoadMem32FromFile_Test_WriteError");
    UtTest_Add(MM_DumpMem32ToFile_Test_Nominal, MM_Test_Setup, MM_Test_TearDown, "MM_DumpMem32ToFile_Test_Nominal");
    UtTest_Add(MM_DumpMem32ToFile_Test_CPUHogging, MM_Test_Setup, MM_Test_TearDown, "MM_DumpMem32ToFile_Test_CPUHogging");
    UtTest_Add(MM_DumpMem32ToFile_Test_ReadError, MM_Test_Setup, MM_Test_TearDown, "MM_DumpMem32ToFile_Test_ReadError");
    UtTest_Add(MM_DumpMem32ToFile_Test_WriteError, MM_Test_Setup, MM_Test_TearDown, "MM_DumpMem32ToFile_Test_WriteError");
...
} /* end MM_Mem32_Test_AddTestCases */
